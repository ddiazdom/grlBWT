...
#include <cds/hash_table.hpp>
#include <cds/int_array.h>
#include <cds/rank_support.h>

#define BUFFER_SIZE 8388608 //8MB of buffer

typedef bit_array                        bv_t;
typedef rank_support<>                   bv_rs_t;
typedef int_array<>                      vector_t;
typedef int_array<>                      string_t;
