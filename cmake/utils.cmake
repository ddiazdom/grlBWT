...
function(enable_bmi2_if_requested target_name)
    if(BMI2)
        check_cxx_compiler_flag("-mbmi2" COMPILER_SUPPORTS_BMI2)
        if(COMPILER_SUPPORTS_BMI2)
            message(STATUS "Compiler supports BMI2, enabling it for ${target_name}")
            target_compile_options(${target_name} PRIVATE -mbmi2)
        endif()
    else()
        message(STATUS "BMI2 disabled for ${target_name}")
    endif()
endfunction()
...
function(configure_target target_name enable_sdsl opt_flags)
    ...
    if(opt_flags)
        ...
        enable_bmi2_if_requested(${target_name})
    else()
